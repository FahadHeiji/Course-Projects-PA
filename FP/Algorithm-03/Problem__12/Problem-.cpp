...
bool isTepical(int arr[3][3], int arr2[3][3])
{
    for (short row = 0; row < 3; row++)
    {
        for (short col = 0; col < 3; col++)
...
int main()
{
    ...
    Layout::setProgramHeader("Check Tepicalty of Two Matries");
    ...
    if (isTepical(Matrix1, Matrix2))
        cout << "Yes: Matrieces Are Tepical.\n";
    else
        cout << "No: Matrieces Are NOT Tepical.\n";
    return 0;
}